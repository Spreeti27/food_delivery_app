      ...
      body:Column(
        ...
        children: [
          ScaleTransition(scale:animation,
              child: Center(child: Image.asset("assets/image/logo1.jpg",width: Dimensions.splashImg,))),
          Center(child: Image.asset("assets/image/logo2.png",width: Dimensions.splashImg,)),
        ],
      ),
    );
  }
